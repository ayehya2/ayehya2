...
<table align="center">
  ...
  <tr>
    <td>
      <b>Languages:</b> TypeScript, Python, JavaScript, C/C++, Rust, Java, HTML/CSS<br>
      <b>Frontend:</b> React, Next.js, React Native, Expo, Tailwind CSS, Framer Motion, Radix UI<br>
      <b>Backend:</b> Node.js, Express, Flask, Hono, Supabase<br>
      <b>Desktop/Mobile:</b> Tauri, Expo, React Native<br>
      <b>AI/ML:</b> TensorFlow, scikit-learn, XGBoost, Google Gemini API, NLP<br>
      <b>Data:</b> PostgreSQL, Supabase, SQLite, MongoDB<br>
      <b>Security/OSINT:</b> Cryptography, Network Security, Maigret, Web Scraping<br>
      <b>Tools:</b> Git, Linux, Docker, Vite, Vercel, Selenium, Puppeteer
    </td>
    <td>
